/**
 * Drop leftover merch from wave29 and backfill missing ingredients from product pages.
 */
...
async function main() {
  ...
  const report = {
    ...
    newlyFilled: filled,
    wave29Products: wave.length,
    wave29WithIngredients: withIng,
  };
  fs.writeFileSync(
    path.join(root, "data/wave29-ingredients-backfill.json"),
