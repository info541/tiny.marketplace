/**
 * Drop leftover merch from wave36 and backfill missing ingredients from product pages.
 */
...
async function main() {
  ...
  const report = {
    ...
    newlyFilled: filled,
    wave36Products: wave.length,
    wave36WithIngredients: withIng,
  };
  fs.writeFileSync(
    path.join(root, "data/wave36-ingredients-backfill.json"),
