/**
 * Drop leftover merch from wave44 and backfill missing ingredients from product pages.
 */
...
async function main() {
  ...
  const report = {
    ...
    newlyFilled: filled,
    wave44Products: wave.length,
    wave44WithIngredients: withIng,
  };
  fs.writeFileSync(
    path.join(root, "data/wave44-ingredients-backfill.json"),
