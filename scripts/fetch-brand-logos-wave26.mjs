/**
 * Generate logos for wave26 brands (uplead → generated SVG mark).
 */
...
const catalogPath = path.join(__dirname, "../src/lib/catalog-brands-wave26.ts");
...
fs.writeFileSync(
  path.join(__dirname, "../data/brand-logo-manifest-wave26.json"),
