/**
 * Drop leftover merch from wave30 and backfill missing ingredients from product pages.
 */
...
async function main() {
  ...
  const report = {
    ...
    newlyFilled: filled,
    wave30Products: wave.length,
    wave30WithIngredients: withIng,
  };
  fs.writeFileSync(
    path.join(root, "data/wave30-ingredients-backfill.json"),
