/**
 * Generate logos for wave53 brands (uplead → generated SVG mark).
 */
...
const catalogPath = path.join(__dirname, "../src/lib/catalog-brands-wave53.ts");
...
fs.writeFileSync(
  path.join(__dirname, "../data/brand-logo-manifest-wave53.json"),
