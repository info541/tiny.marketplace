/**
 * Drop leftover merch from wave40 and backfill missing ingredients from product pages.
 */
...
async function main() {
  ...
  const report = {
    ...
    newlyFilled: filled,
    wave40Products: wave.length,
    wave40WithIngredients: withIng,
  };
  fs.writeFileSync(
    path.join(root, "data/wave40-ingredients-backfill.json"),
