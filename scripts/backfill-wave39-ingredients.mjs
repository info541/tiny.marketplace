/**
 * Drop leftover merch from wave39 and backfill missing ingredients from product pages.
 */
...
async function main() {
  ...
  const report = {
    ...
    newlyFilled: filled,
    wave39Products: wave.length,
    wave39WithIngredients: withIng,
  };
  fs.writeFileSync(
    path.join(root, "data/wave39-ingredients-backfill.json"),
