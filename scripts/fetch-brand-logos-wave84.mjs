/**
 * Generate logos for wave84 brands (uplead → generated SVG mark).
 */
...
const catalogPath = path.join(__dirname, "../src/lib/catalog-brands-wave84.ts");
...
fs.writeFileSync(
  path.join(__dirname, "../data/brand-logo-manifest-wave84.json"),
