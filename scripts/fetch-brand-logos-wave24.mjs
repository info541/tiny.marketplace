/**
 * Generate logos for wave24 brands (uplead → generated SVG mark).
 */
...
const catalogPath = path.join(__dirname, "../src/lib/catalog-brands-wave24.ts");
...
fs.writeFileSync(
  path.join(__dirname, "../data/brand-logo-manifest-wave24.json"),
