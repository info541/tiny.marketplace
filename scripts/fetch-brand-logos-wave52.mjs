/**
 * Generate logos for wave52 brands (uplead → generated SVG mark).
 */
...
const catalogPath = path.join(__dirname, "../src/lib/catalog-brands-wave52.ts");
...
fs.writeFileSync(
  path.join(__dirname, "../data/brand-logo-manifest-wave52.json"),
