/**
 * Generate logos for wave35 brands (uplead → generated SVG mark).
 */
...
const catalogPath = path.join(__dirname, "../src/lib/catalog-brands-wave35.ts");
...
fs.writeFileSync(
  path.join(__dirname, "../data/brand-logo-manifest-wave35.json"),
