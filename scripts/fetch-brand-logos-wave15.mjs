/**
 * Generate logos for wave15 brands (uplead → generated SVG mark).
 */
...
const catalogPath = path.join(__dirname, "../src/lib/catalog-brands-wave15.ts");
...
fs.writeFileSync(
  path.join(__dirname, "../data/brand-logo-manifest-wave15.json"),
