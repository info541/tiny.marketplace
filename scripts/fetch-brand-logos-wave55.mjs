/**
 * Generate logos for wave55 brands (uplead → generated SVG mark).
 */
...
const catalogPath = path.join(__dirname, "../src/lib/catalog-brands-wave55.ts");
...
fs.writeFileSync(
  path.join(__dirname, "../data/brand-logo-manifest-wave55.json"),
