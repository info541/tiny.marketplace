/**
 * Generate logos for wave12 brands (uplead → generated SVG mark).
 */
...
const catalogPath = path.join(__dirname, "../src/lib/catalog-brands-wave12.ts");
...
fs.writeFileSync(
  path.join(__dirname, "../data/brand-logo-manifest-wave12.json"),
