/**
 * Fetch Shopify catalogs for wave103 brands (c1487+).
...
import { brands as seedBrands } from "./catalog-brands-seed-wave103.mjs";
...
function refineCategory(category, title, brand) {
  ...
  if (brand?.slug === "jack-n-jill") {
    if (/shampoo|conditioner|detangler|hair/i.test(t)) return "hair";
    if (/moisturizer|baby wash|hand wash/i.test(t)) return "skincare";
    return "oral";
  }
  if (brand?.slug === "natrilyte") return "electrolytes";
  if (brand?.slug === "smash-melon") return "protein";
  if (brand?.slug === "we-are-feel-good-inc") {
    if (/after sun/i.test(t)) return "skincare";
    if (/cleanser|body milk|coco milk|moisturis/i.test(t)) return "skincare";
    if (/lip balm/i.test(t)) return "sunscreen";
    return "sunscreen";
  }
  if (brand?.slug === "mooses-tallow") {
    if (/deodorant/i.test(t)) return "deodorant";
    if (/sun balm|zinc/i.test(t) && !/diaper|baby bum/i.test(t)) return "sunscreen";
    if (/after sun/i.test(t)) return "skincare";
    if (/hair clay|beard/i.test(t)) return "hair";
    return "skincare";
  }
  if (brand?.slug === "forest-of-dean-mushrooms") return "supplements";
  return category;
}

const JNJ_KEEP = new Set([
  "natural-certified-toothpaste-watermelon-50g",
  "natural-certified-toothpaste-apple-50g-copy",
  "jack-n-jill-strawberry-natural-toothpaste-50g",
  "jack-n-jill-milkshake-natural-toothpaste-50g",
  "jack-n-jill-blueberry-natural-toothpaste-50g",
  "jack-n-jill-berries-cream-natural-toothpaste-50g-1",
  "jack-n-jill-bubblegum-natural-toothpaste-50g",
  "jack-n-jill-flavor-free-natural-toothpaste-50g",
  "jack-n-jill-banana-natural-toothpaste-50g",
  "jack-n-jill-raspberry-natural-toothpaste-50g",
  "jack-n-jill-blackcurrant-natural-toothpaste-50g",
  "jack-n-jill-baby-gum-tooth-gel-15g",
  "tooth-sparkles-tooth-cleaning-chews",
  "jack-n-jill-fairy-floss-30-pack",
  "nfco-friendly-flossers-45-pack",
  "jack-n-jill-stage-1-silicone-finger-brush-2-pack",
  "jack-n-jill-stage-2-silicone-toothbrush-1",
  "jack-n-jill-stage-3-silicone-tooth-gum-brush",
  "jack-n-jill-bunny-bio-toothbrush",
  "jack-n-jill-baby-gum-tooth-wipes-25-pack",
  "jack-n-jill-baby-wash-natural-300ml",
  "jack-n-jill-detangler-leave-in-conditioner-natural-200ml",
  "jack-n-jill-shampoo-body-wash-natural-300ml",
  "jack-n-jill-serenity-shampoo-body-wash-natural-300ml",
  "jack-n-jill-simplicity-shampoo-body-wash-natural-300ml-1",
  "jack-n-jill-serenity-moisturizer-natural-300ml",
  "jack-n-jill-sweetness-moisturizer-natural-300ml-1",
  "jack-n-jill-simplicity-moisturizer-natural-300ml",
  "jack-n-jill-serenity-hand-wash-natural-300ml",
  "jack-n-jill-sweetness-hand-wash-natural-300ml",
  "jack-n-jill-simplicity-hand-wash-natural-300ml",
]);

const FEEL_KEEP = new Set([
  "baby-sunscreen",
  "wild-rosella-sunscreen-spf-50",
  "sport-sunscreen",
  "signature-lip-balm-spf50",
  "mineral-zinc-sunscreen-limited-edition",
  "mineral-sunscreen",
  "kids-sunscreen-lotion",
  "tropical-body-milk",
  "mineral-zinc-stick-spf50",
  "tropical-lip-balm-spf50",
  "tropical-sunscreen-spf50",
  "foaming-cleanser",
  "wild-rosella-body-milk",
  "sensitive-sunscreen",
  "sensitive-lip-balm-spf-50",
  "kakadu-plum-lip-balm-spf-50",
  "coconut-lip-balm-spf-50",
  "good-morning-spf50",
  "after-sun-cooling-lotion-1",
  "kakadu-plum-sunscreen-lotion-spf-50",
  "sticky-zinc-tinted-sunscreen",
  "kakadu-plum-lotion",
  "coconut-sunscreen",
  "coconut-moisturiser",
  "sunscreen-spf-50",
...
const MOOSE_KEEP = new Set([
  "lingonberry-whipped-tallow-body-butter",
  "mindys-honey-lemon-whipped-tallow-body-butter",
  "blackberries-and-cream-whipped-tallow-body-butter",
  "anti-aging-tallow-night-cream-for-face-night-repair",
  "evergreen-tallow-beard-balm-infused-with-egg-yolk-oil",
  "spicy-rum-tallow-beard-balm-infused-with-egg-yolk-oil",
  "vanilla-chai-whipped-tallow-body-butter",
  "vanilla-ember-whipped-tallow-body-butter",
  "toasted-pistachio-caramel-whipped-tallow-body-butter",
  "peach-blossom-whipped-tallow-body-butter",
  "mahogany-teakwood-whipped-tallow-body-butter",
  "honeysuckle-whipped-tallow-body-butter",
  "lavender-vanilla-whipped-tallow-body-butter",
  "heavenly-whipped-tallow-body-butter",
  "fruity-cereal-whipped-tallow-body-butter",
  "fresh-strawberry-whipped-tallow-body-butter",
  "forest-falls-whipped-tallow-body-butter",
  "dark-cocoa-whipped-tallow-body-butter",
  "coconut-whipped-tallow-body-butter",
  "caramel-mocha-whipped-tallow-body-butter",
  "apricot-honey-whipped-tallow-body-butter",
  "apple-pecan-whipped-tallow-body-butter",
  "sun-balm-30-zinc-unscented",
  "sun-balm-20-zinc-coconut",
  "sugar-cookie-tallow-lip-balm",
  "pumpkin-pie-tallow-lip-balm",
  "very-cherry-tallow-lip-balm",
  "vanilla-tallow-lip-balm",
  "natural-tallow-lip-balm",
  "pina-colada-tallow-lip-balm",
  "peppermint-tallow-lip-balm",
  "lemon-tallow-lip-balm",
  "chocolate-hazelnut-tallow-lip-balm",
  "chai-tallow-lip-balm",
  "chocolate-mint-tallow-lip-balm",
  "tallow-hair-clay-medium-hold",
  "blackberries-and-cream-sugar-scrub",
  "toasted-pistachio-caramel-sugar-scrub",
  "coconut-sugar-scrub",
  "fresh-strawberry-sugar-scrub",
  "lavender-natural-deodorant",
  "sandalwood-natural-deodorant",
  "unscented-natural-deodorant",
  "forest-falls-natural-deodorant",
  "baby-bum-butter",
  "hand-repair",
  "coconut-after-sun-butter-tallow-body-butter-for-dry-summer-skin",
  "coconut-natural-deodorant",
  "tallow-hair-clay",
  "tallow-zinc-sun-butter-balm",
  "baby-butter-all-natural-tallow-balm",
  "tallow-egg-yolk-oil-infused-beard-hair-balm",
  "eye-awake-natural-retinol-alternative-for-dark-circles",
  "sleep-tight-magnesium-infused-tallow-body-butter",
  "healing-tallow-lip-balm",
  "whipped-beef-tallow-lotion-body-butter",
]);

const FOD_KEEP = new Set(["reishi-mushroom-dual-extraction-tincture", "lions-mane-tincture"]);
...
function isOnNiche(raw, brand) {
  ...
  if (brand.slug === "jack-n-jill") return JNJ_KEEP.has(handle);
  if (brand.slug === "natrilyte") return handle === "natrilyte-premium-electrolyte-complex";
  if (brand.slug === "smash-melon") return handle === "watermelon-protein-powder";
  if (brand.slug === "we-are-feel-good-inc") return FEEL_KEEP.has(handle);
  if (brand.slug === "mooses-tallow") return MOOSE_KEEP.has(handle);
  if (brand.slug === "forest-of-dean-mushrooms") return FOD_KEEP.has(handle);
  if (SKIP_TITLE.test(title) || WAVE103_EXTRA.test(title) || WAVE103_EXTRA.test(handle)) return false;
...
function flavorOptionIndex(raw, brand) {
  ...
  const handle = raw.handle || "";
  if (brand?.slug === "jack-n-jill") return -1;
  if (brand?.slug === "smash-melon") return -1;
  if (brand?.slug === "forest-of-dean-mushrooms") return -1;
  if (brand?.slug === "natrilyte") {
    return options.findIndex((o) => /flavou?r/i.test(o.name || ""));
  }
  if (brand?.slug === "we-are-feel-good-inc") {
    return options.findIndex((o) => /colour|color|style/i.test(o.name || ""));
  }
  if (brand?.slug === "mooses-tallow") {
    if (/hair-clay/.test(handle)) return options.findIndex((o) => /scent/i.test(o.name || ""));
    return -1;
  }
...
function pickVariant(variants, brand, raw) {
  ...
  const scored = variants.map((v, i) => {
    ...
    if (/\b(two-pack|2-pack|three-pack|3-pack|four-pack|4-pack|2 boxes|4 boxes|6 boxes|0\.5oz|0\.5 oz|20 servings|3x90|250 g|250g|500 g|500g|1 kg|1kg|5g|sample size|refill only|2 jars|3 jars|5 jars|2 bars|3 bars|8 oz extra|16 oz|5lb|5 lb|family size|81 servings|15 servings|30 ct|3\.3 oz|refill cartridge|30g sample)\b/i.test(hay))
      score -= 8;
    if (brand?.slug === "we-are-feel-good-inc") {
      if (/\b(200\s*m?l|100\s*m?l|100g)\b/i.test(hay)) score += 8;
      if (/\b(75\s*m?l|traveller|400\s*m?l|400g|300g)\b/i.test(hay)) score -= 6;
    }
    if (brand?.slug === "mooses-tallow") {
      if (/\b(medium|1\.7\s*oz|1\.9\s*oz|2\s*oz|4\.4\s*oz)\b/i.test(hay)) score += 10;
      if (/\b(small|0\.85\s*oz|large|3\.4\s*oz|3\.6\s*oz|10\s*oz|4\s*oz · 30)\b/i.test(hay)) score -= 6;
    }
...
function mapOne(raw, brand, brandId, index, variant, flavorLabel, currency) {
  ...
  if (brand.slug === "jack-n-jill") {
    const h = raw.handle || "";
    if (/watermelon-50g/.test(h)) baseTitle = "Jack N' Jill Natural Certified Toothpaste — Watermelon";
    else if (/apple-50g/.test(h)) baseTitle = "Jack N' Jill Natural Certified Toothpaste — Apple";
    else if (/strawberry-natural-toothpaste-50g/.test(h))
      baseTitle = "Jack N' Jill Natural Certified Toothpaste — Strawberry";
    else if (/milkshake-natural-toothpaste/.test(h))
      baseTitle = "Jack N' Jill Natural Certified Toothpaste — Milkshake";
    else if (/blueberry-natural-toothpaste/.test(h))
      baseTitle = "Jack N' Jill Natural Certified Toothpaste — Blueberry";
    else if (/berries-cream/.test(h))
      baseTitle = "Jack N' Jill Natural Certified Toothpaste — Berries & Cream";
    else if (/bubblegum-natural-toothpaste/.test(h))
      baseTitle = "Jack N' Jill Natural Certified Toothpaste — Bubblegum";
    else if (/flavor-free/.test(h))
      baseTitle = "Jack N' Jill Natural Certified Toothpaste — Flavor Free";
    else if (/banana-natural-toothpaste/.test(h))
      baseTitle = "Jack N' Jill Natural Certified Toothpaste — Banana";
    else if (/raspberry-natural-toothpaste/.test(h))
      baseTitle = "Jack N' Jill Natural Certified Toothpaste — Raspberry";
    else if (/blackcurrant-natural-toothpaste/.test(h))
      baseTitle = "Jack N' Jill Natural Certified Toothpaste — Blackcurrant";
    else if (/baby-gum-tooth-gel/.test(h)) baseTitle = "Jack N' Jill Baby Gum & Tooth Gel";
    else if (/tooth-sparkles/.test(h)) baseTitle = "Jack N' Jill Tooth Sparkles";
    else if (/fairy-floss/.test(h)) baseTitle = "Jack N' Jill Fairy Floss";
    else if (/friendly-flossers/.test(h)) baseTitle = "Jack N' Jill NFco Friendly Flossers";
    else if (/stage-1/.test(h)) baseTitle = "Jack N' Jill Silicone Finger Brush Stage 1";
    else if (/stage-2/.test(h)) baseTitle = "Jack N' Jill Silicone Toothbrush Stage 2";
    else if (/stage-3/.test(h)) baseTitle = "Jack N' Jill Silicone Tooth & Gum Brush Stage 3";
    else if (/bunny-bio/.test(h)) baseTitle = "Jack N' Jill Kids Bio Toothbrush — Bunny";
    else if (/gum-tooth-wipes/.test(h)) baseTitle = "Jack N' Jill Baby Gum & Tooth Wipes";
    else if (!/^jack n' jill\b/i.test(baseTitle)) baseTitle = `Jack N' Jill ${baseTitle}`;
  }
  if (brand.slug === "natrilyte") baseTitle = "Natrilyte Premium Electrolyte Complex";
  if (brand.slug === "smash-melon") baseTitle = "Smash Melon Watermelon Seed Protein";
  if (brand.slug === "we-are-feel-good-inc") {
    if (!/^we are feel good/i.test(baseTitle)) baseTitle = `We Are Feel Good Inc. ${baseTitle}`;
  }
  if (brand.slug === "mooses-tallow") {
    if (!/^moose/i.test(baseTitle)) baseTitle = `Moose's Tallow ${baseTitle}`;
  }
  if (brand.slug === "forest-of-dean-mushrooms") {
    const h = raw.handle || "";
    if (/reishi/.test(h)) baseTitle = "Forest of Dean Reishi 1:3 Dual-Extract Tincture";
    else if (/lions-mane/.test(h)) baseTitle = "Forest of Dean Lion's Mane 1:3 Dual-Extract Tincture";
  }
  ...
  if (brand.slug === "natrilyte" || brand.slug === "we-are-feel-good-inc") {
    ingredients = [];
  }
  if (brand.slug === "jack-n-jill") {
    if (!/hand wash|moisturizer/i.test(title)) ingredients = [];
  }
  if (brand.slug === "smash-melon") {
    ingredients = ["Watermelon seed protein"];
  }
  if (brand.slug === "mooses-tallow") {
    if (/lip balm/i.test(title)) {
      ingredients = ["Grass-fed beef tallow", "Egg yolk oil", "Beeswax"];
    } else {
      ingredients = [];
    }
  }
  if (brand.slug === "forest-of-dean-mushrooms") {
    if (/reishi/i.test(title)) {
      ingredients = ["Reishi fruiting body", "Organic grain alcohol", "Distilled hot water"];
    } else if (/lion'?s mane/i.test(title)) {
      ingredients = ["Lion's Mane fruiting body", "Organic grain alcohol", "Distilled hot water"];
    } else {
      ingredients = [];
    }
  }
...
function expandProducts(raw, brand, brandId, index, currency) {
  ...
  if (flavorIdx >= 0 && variants.length > 1) {
    ...
    for (const v of variants) {
      ...
      if (brand?.slug === "natrilyte" && /variety/i.test(label)) continue;
...
async function main() {
  ...
  fs.writeFileSync(
    path.join(root, "data/catalog-products-manifest-wave103.json"),
    JSON.stringify(
      {
        generatedAt: new Date().toISOString(),
        wave103Products: waveCount,
        wave103BrandsWithProducts: perBrand.filter((b) => b.kept > 0).length,
  ...
  fs.writeFileSync(
    path.join(root, "data/wave103-selected.json"),
    JSON.stringify(
      seedBrands.map((b, i) => ({
        slug: b.slug,
        shopBase: b.shopBase,
  ...
  console.log(
    `\nDone total=${all.length} wave103=${waveCount} brandsWithProducts=${perBrand.filter((b) => b.kept > 0).length} failures=${failures.length}`,
  );
}
