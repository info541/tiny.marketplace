/**
 * Generate logos for wave71 brands (uplead → generated SVG mark).
 */
...
const catalogPath = path.join(__dirname, "../src/lib/catalog-brands-wave71.ts");
...
fs.writeFileSync(
  path.join(__dirname, "../data/brand-logo-manifest-wave71.json"),
