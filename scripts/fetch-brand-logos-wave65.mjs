/**
 * Generate logos for wave65 brands (uplead → generated SVG mark).
 */
...
const catalogPath = path.join(__dirname, "../src/lib/catalog-brands-wave65.ts");
...
fs.writeFileSync(
  path.join(__dirname, "../data/brand-logo-manifest-wave65.json"),
