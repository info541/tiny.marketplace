/**
 * Drop leftover merch from wave50 and backfill missing ingredients from product pages.
 */
...
async function main() {
  ...
  const report = {
    ...
    newlyFilled: filled,
    wave50Products: wave.length,
    wave50WithIngredients: withIng,
  };
  fs.writeFileSync(
    path.join(root, "data/wave50-ingredients-backfill.json"),
