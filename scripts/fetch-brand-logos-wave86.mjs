/**
 * Download wave86 brand logos into public/brands/{slug}.png (or .svg fallback).
 */
...
const catalogPath = path.join(__dirname, "../src/lib/catalog-brands-wave86.ts");
...
fs.writeFileSync(
  path.join(__dirname, "../data/brand-logo-manifest-wave86.json"),
