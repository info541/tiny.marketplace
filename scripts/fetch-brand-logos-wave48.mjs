/**
 * Generate logos for wave48 brands (uplead → generated SVG mark).
 */
...
const catalogPath = path.join(__dirname, "../src/lib/catalog-brands-wave48.ts");
...
fs.writeFileSync(
  path.join(__dirname, "../data/brand-logo-manifest-wave48.json"),
