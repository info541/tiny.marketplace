/**
 * Generate logos for wave69 brands (uplead → generated SVG mark).
 */
...
const catalogPath = path.join(__dirname, "../src/lib/catalog-brands-wave69.ts");
...
fs.writeFileSync(
  path.join(__dirname, "../data/brand-logo-manifest-wave69.json"),
