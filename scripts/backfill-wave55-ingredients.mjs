/**
 * Drop leftover merch from wave55 and backfill missing ingredients from product pages.
 */
...
async function main() {
  ...
  const report = {
    ...
    newlyFilled: filled,
    wave55Products: wave.length,
    wave55WithIngredients: withIng,
  };
  fs.writeFileSync(
    path.join(root, "data/wave55-ingredients-backfill.json"),
