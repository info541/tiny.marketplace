/**
 * Generate logos for wave46 brands (uplead → generated SVG mark).
 */
...
const catalogPath = path.join(__dirname, "../src/lib/catalog-brands-wave46.ts");
...
fs.writeFileSync(
  path.join(__dirname, "../data/brand-logo-manifest-wave46.json"),
