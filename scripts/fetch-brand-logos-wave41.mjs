/**
 * Generate logos for wave41 brands (uplead → generated SVG mark).
 */
...
const catalogPath = path.join(__dirname, "../src/lib/catalog-brands-wave41.ts");
...
fs.writeFileSync(
  path.join(__dirname, "../data/brand-logo-manifest-wave41.json"),
