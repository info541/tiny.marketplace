/**
 * Generate logos for wave57 brands (uplead → generated SVG mark).
 */
...
const catalogPath = path.join(__dirname, "../src/lib/catalog-brands-wave57.ts");
...
fs.writeFileSync(
  path.join(__dirname, "../data/brand-logo-manifest-wave57.json"),
