/**
 * Generate logos for wave19 brands (uplead → generated SVG mark).
 */
...
const catalogPath = path.join(__dirname, "../src/lib/catalog-brands-wave19.ts");
...
fs.writeFileSync(
  path.join(__dirname, "../data/brand-logo-manifest-wave19.json"),
