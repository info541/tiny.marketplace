/**
 * Generate logos for wave76 brands (uplead → generated SVG mark).
 */
...
const catalogPath = path.join(__dirname, "../src/lib/catalog-brands-wave76.ts");
...
fs.writeFileSync(
  path.join(__dirname, "../data/brand-logo-manifest-wave76.json"),
