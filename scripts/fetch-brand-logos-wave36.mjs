/**
 * Generate logos for wave36 brands (uplead → generated SVG mark).
 */
...
const catalogPath = path.join(__dirname, "../src/lib/catalog-brands-wave36.ts");
...
fs.writeFileSync(
  path.join(__dirname, "../data/brand-logo-manifest-wave36.json"),
