/**
 * Generate logos for wave33 brands (uplead → generated SVG mark).
 */
...
const catalogPath = path.join(__dirname, "../src/lib/catalog-brands-wave33.ts");
...
fs.writeFileSync(
  path.join(__dirname, "../data/brand-logo-manifest-wave33.json"),
