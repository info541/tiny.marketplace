/**
 * Generate logos for wave72 brands (uplead → generated SVG mark).
 */
...
const catalogPath = path.join(__dirname, "../src/lib/catalog-brands-wave72.ts");
...
fs.writeFileSync(
  path.join(__dirname, "../data/brand-logo-manifest-wave72.json"),
