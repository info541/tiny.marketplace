/**
 * Generate logos for wave43 brands (uplead → generated SVG mark).
 */
...
const catalogPath = path.join(__dirname, "../src/lib/catalog-brands-wave43.ts");
...
fs.writeFileSync(
  path.join(__dirname, "../data/brand-logo-manifest-wave43.json"),
