/**
 * Generate logos for wave61 brands (uplead → generated SVG mark).
 */
...
const catalogPath = path.join(__dirname, "../src/lib/catalog-brands-wave61.ts");
...
fs.writeFileSync(
  path.join(__dirname, "../data/brand-logo-manifest-wave61.json"),
