/**
 * Drop leftover merch from wave27 and backfill missing ingredients from product pages.
 */
...
async function main() {
  ...
  const report = {
    ...
    newlyFilled: filled,
    wave27Products: wave.length,
    wave27WithIngredients: withIng,
  };
  fs.writeFileSync(
    path.join(root, "data/wave27-ingredients-backfill.json"),
