/**
 * Generate logos for wave8 brands (uplead → generated SVG mark).
 */
...
const catalogPath = path.join(__dirname, "../src/lib/catalog-brands-wave8.ts");
...
fs.writeFileSync(
  path.join(__dirname, "../data/brand-logo-manifest-wave8.json"),
