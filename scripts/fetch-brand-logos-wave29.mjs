/**
 * Generate logos for wave29 brands (uplead → generated SVG mark).
 */
...
const catalogPath = path.join(__dirname, "../src/lib/catalog-brands-wave29.ts");
...
fs.writeFileSync(
  path.join(__dirname, "../data/brand-logo-manifest-wave29.json"),
