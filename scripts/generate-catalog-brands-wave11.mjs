/**
 * Write src/lib/catalog-brands-wave11.ts from the wave11 seed.
 */
...
const out = path.join(__dirname, "../src/lib/catalog-brands-wave11.ts");
...
const rows = brands.map((b, i) => {
  const id = `c${String(i + 601).padStart(3, "0")}`;
  return `  {
    id: ${tsString(id)},
