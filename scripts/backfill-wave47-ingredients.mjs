/**
 * Drop leftover merch from wave47 and backfill missing ingredients from product pages.
 */
...
async function main() {
  ...
  const report = {
    ...
    newlyFilled: filled,
    wave47Products: wave.length,
    wave47WithIngredients: withIng,
  };
  fs.writeFileSync(
    path.join(root, "data/wave47-ingredients-backfill.json"),
