/**
 * Generate logos for wave34 brands (uplead → generated SVG mark).
 */
...
const catalogPath = path.join(__dirname, "../src/lib/catalog-brands-wave34.ts");
...
fs.writeFileSync(
  path.join(__dirname, "../data/brand-logo-manifest-wave34.json"),
