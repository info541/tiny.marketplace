/**
 * Generate logos for wave49 brands (uplead → generated SVG mark).
 */
...
const catalogPath = path.join(__dirname, "../src/lib/catalog-brands-wave49.ts");
...
fs.writeFileSync(
  path.join(__dirname, "../data/brand-logo-manifest-wave49.json"),
