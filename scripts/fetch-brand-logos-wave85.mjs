/**
 * Generate logos for wave85 brands (uplead → generated SVG mark).
 */
...
const catalogPath = path.join(__dirname, "../src/lib/catalog-brands-wave85.ts");
...
fs.writeFileSync(
  path.join(__dirname, "../data/brand-logo-manifest-wave85.json"),
