/**
 * Generate logos for wave75 brands (uplead → generated SVG mark).
 */
...
const catalogPath = path.join(__dirname, "../src/lib/catalog-brands-wave75.ts");
...
fs.writeFileSync(
  path.join(__dirname, "../data/brand-logo-manifest-wave75.json"),
