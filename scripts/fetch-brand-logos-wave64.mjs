/**
 * Generate logos for wave64 brands (uplead → generated SVG mark).
 */
...
const catalogPath = path.join(__dirname, "../src/lib/catalog-brands-wave64.ts");
...
fs.writeFileSync(
  path.join(__dirname, "../data/brand-logo-manifest-wave64.json"),
