/**
 * Drop leftover merch from wave59 and backfill missing ingredients from product pages.
 */
...
async function main() {
  ...
  const report = {
    ...
    newlyFilled: filled,
    wave59Products: wave.length,
    wave59WithIngredients: withIng,
  };
  fs.writeFileSync(
    path.join(root, "data/wave59-ingredients-backfill.json"),
