/**
 * Generate logos for wave45 brands (uplead → generated SVG mark).
 */
...
const catalogPath = path.join(__dirname, "../src/lib/catalog-brands-wave45.ts");
...
fs.writeFileSync(
  path.join(__dirname, "../data/brand-logo-manifest-wave45.json"),
