/**
 * Drop leftover merch from wave45 and backfill missing ingredients from product pages.
 */
...
async function main() {
  ...
  const report = {
    ...
    newlyFilled: filled,
    wave45Products: wave.length,
    wave45WithIngredients: withIng,
  };
  fs.writeFileSync(
    path.join(root, "data/wave45-ingredients-backfill.json"),
