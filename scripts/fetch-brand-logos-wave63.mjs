/**
 * Generate logos for wave63 brands (uplead → generated SVG mark).
 */
...
const catalogPath = path.join(__dirname, "../src/lib/catalog-brands-wave63.ts");
...
fs.writeFileSync(
  path.join(__dirname, "../data/brand-logo-manifest-wave63.json"),
