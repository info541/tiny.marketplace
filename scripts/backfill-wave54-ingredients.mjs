/**
 * Drop leftover merch from wave54 and backfill missing ingredients from product pages.
 */
...
async function main() {
  ...
  const report = {
    ...
    newlyFilled: filled,
    wave54Products: wave.length,
    wave54WithIngredients: withIng,
  };
  fs.writeFileSync(
    path.join(root, "data/wave54-ingredients-backfill.json"),
