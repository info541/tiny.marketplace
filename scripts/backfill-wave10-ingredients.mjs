/**
 * Drop leftover merch from wave10 and backfill missing ingredients from product pages.
 */
...
async function main() {
  ...
  const report = {
    ...
    newlyFilled: filled,
    wave10Products: wave.length,
    wave10WithIngredients: withIng,
  };
  fs.writeFileSync(
    path.join(root, "data/wave10-ingredients-backfill.json"),
