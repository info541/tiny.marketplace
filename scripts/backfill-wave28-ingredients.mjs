/**
 * Drop leftover merch from wave28 and backfill missing ingredients from product pages.
 */
...
async function main() {
  ...
  const report = {
    ...
    newlyFilled: filled,
    wave28Products: wave.length,
    wave28WithIngredients: withIng,
  };
  fs.writeFileSync(
    path.join(root, "data/wave28-ingredients-backfill.json"),
