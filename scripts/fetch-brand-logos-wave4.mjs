/**
 * Generate logos for wave4 brands (uplead → SVG mark).
 */
...
const catalogPath = path.join(__dirname, "../src/lib/catalog-brands-wave4.ts");
...
fs.writeFileSync(
  path.join(__dirname, "../data/brand-logo-manifest-wave4.json"),
