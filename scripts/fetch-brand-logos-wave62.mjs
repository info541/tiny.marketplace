/**
 * Generate logos for wave62 brands (uplead → generated SVG mark).
 */
...
const catalogPath = path.join(__dirname, "../src/lib/catalog-brands-wave62.ts");
...
fs.writeFileSync(
  path.join(__dirname, "../data/brand-logo-manifest-wave62.json"),
