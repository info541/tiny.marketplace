/**
 * Generate logos for wave25 brands (uplead → generated SVG mark).
 */
...
const catalogPath = path.join(__dirname, "../src/lib/catalog-brands-wave25.ts");
...
fs.writeFileSync(
  path.join(__dirname, "../data/brand-logo-manifest-wave25.json"),
