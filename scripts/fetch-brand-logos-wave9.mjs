/**
 * Generate logos for wave9 brands (uplead → generated SVG mark).
 */
...
const catalogPath = path.join(__dirname, "../src/lib/catalog-brands-wave9.ts");
...
fs.writeFileSync(
  path.join(__dirname, "../data/brand-logo-manifest-wave9.json"),
