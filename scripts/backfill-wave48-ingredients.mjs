/**
 * Drop leftover merch from wave48 and backfill missing ingredients from product pages.
 */
...
async function main() {
  ...
  const report = {
    ...
    newlyFilled: filled,
    wave48Products: wave.length,
    wave48WithIngredients: withIng,
  };
  fs.writeFileSync(
    path.join(root, "data/wave48-ingredients-backfill.json"),
