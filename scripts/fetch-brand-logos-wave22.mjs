/**
 * Generate logos for wave22 brands (uplead → generated SVG mark).
 */
...
const catalogPath = path.join(__dirname, "../src/lib/catalog-brands-wave22.ts");
...
fs.writeFileSync(
  path.join(__dirname, "../data/brand-logo-manifest-wave22.json"),
