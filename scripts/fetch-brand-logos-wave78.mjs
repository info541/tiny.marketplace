/**
 * Generate logos for wave78 brands (uplead → generated SVG mark).
 */
...
const catalogPath = path.join(__dirname, "../src/lib/catalog-brands-wave78.ts");
...
fs.writeFileSync(
  path.join(__dirname, "../data/brand-logo-manifest-wave78.json"),
