/**
 * Generate logos for wave39 brands (uplead → generated SVG mark).
 */
...
const catalogPath = path.join(__dirname, "../src/lib/catalog-brands-wave39.ts");
...
fs.writeFileSync(
  path.join(__dirname, "../data/brand-logo-manifest-wave39.json"),
