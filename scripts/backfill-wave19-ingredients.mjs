/**
 * Drop leftover merch from wave19 and backfill missing ingredients from product pages.
 */
...
async function main() {
  ...
  const report = {
    ...
    newlyFilled: filled,
    wave19Products: wave.length,
    wave19WithIngredients: withIng,
  };
  fs.writeFileSync(
    path.join(root, "data/wave19-ingredients-backfill.json"),
