/**
 * Generate logos for wave38 brands (uplead → generated SVG mark).
 */
...
const catalogPath = path.join(__dirname, "../src/lib/catalog-brands-wave38.ts");
...
fs.writeFileSync(
  path.join(__dirname, "../data/brand-logo-manifest-wave38.json"),
