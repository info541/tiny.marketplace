/**
 * Generate logos for wave31 brands (uplead → generated SVG mark).
 */
...
const catalogPath = path.join(__dirname, "../src/lib/catalog-brands-wave31.ts");
...
fs.writeFileSync(
  path.join(__dirname, "../data/brand-logo-manifest-wave31.json"),
