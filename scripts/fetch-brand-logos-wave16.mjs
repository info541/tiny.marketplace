/**
 * Generate logos for wave16 brands (uplead → generated SVG mark).
 */
...
const catalogPath = path.join(__dirname, "../src/lib/catalog-brands-wave16.ts");
...
fs.writeFileSync(
  path.join(__dirname, "../data/brand-logo-manifest-wave16.json"),
