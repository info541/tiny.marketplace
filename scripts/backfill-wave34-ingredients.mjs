/**
 * Drop leftover merch from wave34 and backfill missing ingredients from product pages.
 */
...
async function main() {
  ...
  const report = {
    ...
    newlyFilled: filled,
    wave34Products: wave.length,
    wave34WithIngredients: withIng,
  };
  fs.writeFileSync(
    path.join(root, "data/wave34-ingredients-backfill.json"),
