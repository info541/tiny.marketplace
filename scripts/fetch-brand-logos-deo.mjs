/**
 * Download logos for deodorant brands into public/brands/{slug}.png|.svg
 * and patch logoUrl paths in src/lib/catalog-brands-deo.ts
 */
import fs from "node:fs";
import path from "node:path";
import { fileURLToPath } from "node:url";
import { brands } from "./catalog-brands-seed-deo.mjs";

const __dirname = path.dirname(fileURLToPath(import.meta.url));
const outDir = path.join(__dirname, "../public/brands");
const catalogPath = path.join(__dirname, "../src/lib/catalog-brands-deo.ts");
...
fs.writeFileSync(
  path.join(__dirname, "../data/brand-logo-manifest-deo.json"),
