/**
 * Generate logos for wave81 brands (uplead → generated SVG mark).
 */
...
const catalogPath = path.join(__dirname, "../src/lib/catalog-brands-wave81.ts");
...
fs.writeFileSync(
  path.join(__dirname, "../data/brand-logo-manifest-wave81.json"),
