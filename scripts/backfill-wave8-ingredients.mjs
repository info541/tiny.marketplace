/**
 * Drop leftover merch from wave8 and backfill missing ingredients from product pages.
 */
...
async function main() {
  ...
  const report = {
    ...
    newlyFilled: filled,
    wave8Products: wave.length,
    wave8WithIngredients: withIng,
  };
  fs.writeFileSync(
    path.join(root, "data/wave8-ingredients-backfill.json"),
