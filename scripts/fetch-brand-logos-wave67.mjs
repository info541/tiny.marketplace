/**
 * Generate logos for wave67 brands (uplead → generated SVG mark).
 */
...
const catalogPath = path.join(__dirname, "../src/lib/catalog-brands-wave67.ts");
...
fs.writeFileSync(
  path.join(__dirname, "../data/brand-logo-manifest-wave67.json"),
