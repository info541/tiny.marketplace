/**
 * Generate logos for wave18 brands (uplead → generated SVG mark).
 */
...
const catalogPath = path.join(__dirname, "../src/lib/catalog-brands-wave18.ts");
...
fs.writeFileSync(
  path.join(__dirname, "../data/brand-logo-manifest-wave18.json"),
