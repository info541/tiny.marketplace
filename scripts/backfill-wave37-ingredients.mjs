/**
 * Drop leftover merch from wave37 and backfill missing ingredients from product pages.
 */
...
async function main() {
  ...
  const report = {
    ...
    newlyFilled: filled,
    wave37Products: wave.length,
    wave37WithIngredients: withIng,
  };
  fs.writeFileSync(
    path.join(root, "data/wave37-ingredients-backfill.json"),
