/**
 * Generate logos for wave6 brands (uplead → generated SVG mark).
 */
...
const catalogPath = path.join(__dirname, "../src/lib/catalog-brands-wave6.ts");
...
fs.writeFileSync(
  path.join(__dirname, "../data/brand-logo-manifest-wave6.json"),
