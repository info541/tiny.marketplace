/**
 * Generate logos for wave79 brands (uplead → generated SVG mark).
 */
...
const catalogPath = path.join(__dirname, "../src/lib/catalog-brands-wave79.ts");
...
fs.writeFileSync(
  path.join(__dirname, "../data/brand-logo-manifest-wave79.json"),
