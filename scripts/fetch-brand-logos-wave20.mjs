/**
 * Generate logos for wave20 brands (uplead → generated SVG mark).
 */
...
const catalogPath = path.join(__dirname, "../src/lib/catalog-brands-wave20.ts");
...
fs.writeFileSync(
  path.join(__dirname, "../data/brand-logo-manifest-wave20.json"),
