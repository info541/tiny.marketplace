/**
 * Drop leftover merch from wave17 and backfill missing ingredients from product pages.
 */
...
async function main() {
  ...
  const report = {
    ...
    newlyFilled: filled,
    wave17Products: wave.length,
    wave17WithIngredients: withIng,
  };
  fs.writeFileSync(
    path.join(root, "data/wave17-ingredients-backfill.json"),
