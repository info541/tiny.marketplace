/**
 * Generate logos for wave42 brands (uplead → generated SVG mark).
 */
...
const catalogPath = path.join(__dirname, "../src/lib/catalog-brands-wave42.ts");
...
fs.writeFileSync(
  path.join(__dirname, "../data/brand-logo-manifest-wave42.json"),
