/**
 * Generate logos for wave10 brands (uplead → generated SVG mark).
 */
...
const catalogPath = path.join(__dirname, "../src/lib/catalog-brands-wave10.ts");
...
fs.writeFileSync(
  path.join(__dirname, "../data/brand-logo-manifest-wave10.json"),
