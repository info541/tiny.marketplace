/**
 * Generate logos for wave82 brands (uplead → generated SVG mark).
 */
...
const catalogPath = path.join(__dirname, "../src/lib/catalog-brands-wave82.ts");
...
fs.writeFileSync(
  path.join(__dirname, "../data/brand-logo-manifest-wave82.json"),
