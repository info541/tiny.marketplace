/**
 * Generate logos for wave14 brands (uplead → generated SVG mark).
 */
...
const catalogPath = path.join(__dirname, "../src/lib/catalog-brands-wave14.ts");
...
fs.writeFileSync(
  path.join(__dirname, "../data/brand-logo-manifest-wave14.json"),
