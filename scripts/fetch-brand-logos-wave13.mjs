/**
 * Generate logos for wave13 brands (uplead → generated SVG mark).
 */
...
const catalogPath = path.join(__dirname, "../src/lib/catalog-brands-wave13.ts");
...
fs.writeFileSync(
  path.join(__dirname, "../data/brand-logo-manifest-wave13.json"),
