/**
 * Generate logos for wave83 brands (uplead → generated SVG mark).
 */
...
const catalogPath = path.join(__dirname, "../src/lib/catalog-brands-wave83.ts");
...
fs.writeFileSync(
  path.join(__dirname, "../data/brand-logo-manifest-wave83.json"),
