/**
 * Generate logos for wave32 brands (uplead → generated SVG mark).
 */
...
const catalogPath = path.join(__dirname, "../src/lib/catalog-brands-wave32.ts");
...
fs.writeFileSync(
  path.join(__dirname, "../data/brand-logo-manifest-wave32.json"),
