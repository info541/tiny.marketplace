/**
 * Generate logos for wave73 brands (uplead → generated SVG mark).
 */
...
const catalogPath = path.join(__dirname, "../src/lib/catalog-brands-wave73.ts");
...
fs.writeFileSync(
  path.join(__dirname, "../data/brand-logo-manifest-wave73.json"),
