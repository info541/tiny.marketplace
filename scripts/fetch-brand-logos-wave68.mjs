/**
 * Generate logos for wave68 brands (uplead → generated SVG mark).
 */
...
const catalogPath = path.join(__dirname, "../src/lib/catalog-brands-wave68.ts");
...
fs.writeFileSync(
  path.join(__dirname, "../data/brand-logo-manifest-wave68.json"),
