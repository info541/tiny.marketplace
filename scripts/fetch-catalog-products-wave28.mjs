...
const FX_TO_USD = {
  "clockwork-rituals": 0.012, // INR
  "earthling-mushroom-farm": 0.029, // THB
};
...
function refineCategory(category, title, brand) {
  ...
  if (/\b(sunbalm|sun[- ]?balm|sunguard|tinted zinc|mineral zinc|zinc tallow|safe sunscreen)\b/.test(t)) {
    return "sunscreen";
  }
  if (/\b(toothpaste|tooth powder|mouth rinse|pulling oil|hydroxyapatite|n[- ]?hap)\b/.test(t)) {
    return "oral";
  }
  ...
  if (/\brecovery drink\b/.test(t)) return "protein";
  if (
