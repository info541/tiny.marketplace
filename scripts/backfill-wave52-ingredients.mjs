/**
 * Drop leftover merch from wave52 and backfill missing ingredients from product pages.
 */
...
async function main() {
  ...
  const report = {
    ...
    newlyFilled: filled,
    wave52Products: wave.length,
    wave52WithIngredients: withIng,
  };
  fs.writeFileSync(
    path.join(root, "data/wave52-ingredients-backfill.json"),
