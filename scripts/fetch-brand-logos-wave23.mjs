/**
 * Generate logos for wave23 brands (uplead → generated SVG mark).
 */
...
const catalogPath = path.join(__dirname, "../src/lib/catalog-brands-wave23.ts");
...
fs.writeFileSync(
  path.join(__dirname, "../data/brand-logo-manifest-wave23.json"),
