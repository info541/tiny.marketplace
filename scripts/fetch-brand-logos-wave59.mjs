/**
 * Generate logos for wave59 brands (uplead → generated SVG mark).
 */
...
const catalogPath = path.join(__dirname, "../src/lib/catalog-brands-wave59.ts");
...
fs.writeFileSync(
  path.join(__dirname, "../data/brand-logo-manifest-wave59.json"),
