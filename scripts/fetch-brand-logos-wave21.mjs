/**
 * Generate logos for wave21 brands (uplead → generated SVG mark).
 */
...
const catalogPath = path.join(__dirname, "../src/lib/catalog-brands-wave21.ts");
...
fs.writeFileSync(
  path.join(__dirname, "../data/brand-logo-manifest-wave21.json"),
