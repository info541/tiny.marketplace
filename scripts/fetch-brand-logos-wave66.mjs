/**
 * Generate logos for wave66 brands (uplead → generated SVG mark).
 */
...
const catalogPath = path.join(__dirname, "../src/lib/catalog-brands-wave66.ts");
...
fs.writeFileSync(
  path.join(__dirname, "../data/brand-logo-manifest-wave66.json"),
