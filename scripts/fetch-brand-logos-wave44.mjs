/**
 * Generate logos for wave44 brands (uplead → generated SVG mark).
 */
...
const catalogPath = path.join(__dirname, "../src/lib/catalog-brands-wave44.ts");
...
fs.writeFileSync(
  path.join(__dirname, "../data/brand-logo-manifest-wave44.json"),
