/**
 * Generate logos for wave28 brands (uplead → generated SVG mark).
 */
...
const catalogPath = path.join(__dirname, "../src/lib/catalog-brands-wave28.ts");
...
fs.writeFileSync(
  path.join(__dirname, "../data/brand-logo-manifest-wave28.json"),
