  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-10 sm:px-5 sm:py-12 md:px-8">
      <div className="flex flex-col gap-5 sm:gap-6 md:flex-row md:items-end md:justify-between">
        ...
        <button type="button" className="btn btn-lemon btn-stack self-stretch sm:self-start md:self-auto" disabled>
          Start a thread (soon)
        </button>
      </div>
      ...
      <div className="mt-10 grid gap-8 sm:mt-12 sm:gap-10 lg:grid-cols-[1.4fr_0.8fr]">
        ...
        <aside className="space-y-4 sm:space-y-5">
          <div className="surface rounded-[1.35rem] p-4 sm:p-5">
            <h2 className="font-display text-xl font-bold tracking-[-0.02em] sm:text-2xl">Fresh reviews</h2>
          ...
          <div className="rounded-[1.35rem] bg-ink p-4 text-foam sm:p-5">
            <h2 className="font-display text-xl font-bold tracking-[-0.02em] sm:text-2xl">Got a tiny brand?</h2>
            <p className="mt-2 text-sm text-foam/75">
              We’re building curation + Shopify storefront sync so your products can live here too.
            </p>
            <Link href="/browse" className="btn btn-lemon mt-5 !min-h-0 !py-2 text-sm">
              Peek the shelf
            </Link>
          </div>
        </aside>
