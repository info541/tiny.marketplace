...
export default async function LoginPage({
  ...
  return (
    <div className="mx-auto flex min-h-[70vh] max-w-md flex-col justify-center px-5 py-14 md:px-8">
      ...
      <h1 className="mt-2 font-display text-4xl font-extrabold tracking-[-0.04em]">Sign in</h1>
      <p className="mt-2 text-ink-soft">Save favorites, leave reviews, and join the talk.</p>
      {params.error ? (
